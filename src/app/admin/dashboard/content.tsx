      ...
      <Container maxW="container.lg" py={10}>
        <VStack spacing={8}>
          <Box bg="white" p={6} rounded="md" shadow="md" w="full">
            ...
            <Text>KBB Super App adalah aplikasi untuk perkumpulan organisasi paguyuban dari berbagai daerah di Indonesia. Aplikasi ini dibuat untuk memudahkan anggota KBB dalam berinteraksi, berbagi informasi, dan menjaga kekayaan budaya Indonesia.</Text>
          </Box>
          <Box bg="white" p={6} rounded="md" shadow="md" w="full">
